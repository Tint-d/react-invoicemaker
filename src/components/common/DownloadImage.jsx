...
const DownloadImage = () => {
  ...
  const { downloadRef, handleDownloadImage,isExporting } = useDownloadRef();
    ...
    <>
      {isExporting ? (
        <Layout>
          <div
            ref={downloadRef}
            className="mb-3 bg-white p-5 w-full rounded-lg flex justify-between items-center "
          >
            {company?.length > 0
              ? companyName && (
          ...
          <div className="bg-white p-3 rounded-xl">
            ...
            <div className="flex flex-col sm:flex-row rounded-lg sm:visible w-full px-4 py-2 items-center sm:justify-end">
              ...
              <div className="font-title w-full sm:w-1/4 text-right sm:pr-8 flex flex-row sm:block mb-1">
                <h2 className="">{invoice?.subTotal}</h2>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row rounded-lg sm:visible w-full px-4 py-2 items-center sm:justify-end">
              <div className="font-title w-full sm:w-1/4 text-right sm:pr-8 flex flex-row sm:block mb-1">
